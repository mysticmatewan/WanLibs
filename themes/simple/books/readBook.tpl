...
{block name=metaTitle}{$book->getTitle()}{if $book->getSubTitle() != null} {$book->getSubTitle()}{/if}{/block}
...
{block name=headerCss append}
    {if $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'fb2'}
        <link rel="stylesheet" href="{$themePath}resources/js/plugins/fb2js/style.css">
    {elseif $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'epub'}
        <link rel="stylesheet" href="{$themePath}resources/js/plugins/epubjs/style.css">
    {/if}
{/block}
{block name=content}
    <div class="page single-book">
        <div class="row">
            ...
            <div class="col-lg-4 text-right">
                <a href="{$routes->getRouteString("bookViewPublic",["bookId"=>$book->getId()])}" class="btn btn-outline-primary"><i class="fa fa-file-text-o" aria-hidden="true"></i> {t}Book Description{/t}</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
...
{block name=footerJs append}
    {if $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'fb2'}
        <script type="text/javascript" src="{$themePath}resources/js/plugins/fb2js/fb2-reader.js"></script>
        <script type="text/javascript" src="{$themePath}resources/js/plugins/epubjs/screenfull.min.js"></script>
    {elseif $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'epub'}
        <script type="text/javascript" src="{$themePath}resources/js/plugins/epubjs/zip.min.js"></script>
        <script type="text/javascript" src="{$themePath}resources/js/plugins/epubjs/epub.min.js"></script>
        <script type="text/javascript" src="{$themePath}resources/js/plugins/epubjs/screenfull.min.js"></script>
    {/if}
{/block}
