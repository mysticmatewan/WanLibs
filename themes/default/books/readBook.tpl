...
{block name=headerCss append}
    {if $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'fb2'}
        <link rel="stylesheet" href="{$themePath}resources/js/fb2js/style.css">
    {elseif $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'epub'}
        <link rel="stylesheet" href="{$themePath}resources/js/epubjs/style.css">
    {/if}
{/block}
{block name=content}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-right">
                    <a href="{$routes->getRouteString("bookViewPublic",["bookId"=>$book->getId()])}" class="btn btn-outline-primary"><i class="fa fa-file-text-o mr-1" aria-hidden="true"></i> {t}Book Description{/t}</a>
                </div>
...
{block name=footerJs append}
    {if $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'fb2'}
        <script type="text/javascript" src="{$themePath}resources/js/fb2js/fb2-reader.js"></script>
        <script type="text/javascript" src="{$themePath}resources/js/epubjs/screenfull.min.js"></script>
    {elseif $book->getEBook() != null and $book->getEBook()->getPath()|pathinfo:$smarty.const.PATHINFO_EXTENSION == 'epub'}
        <script type="text/javascript" src="{$themePath}resources/js/epubjs/zip.min.js"></script>
        <script type="text/javascript" src="{$themePath}resources/js/epubjs/epub.min.js"></script>
        <script type="text/javascript" src="{$themePath}resources/js/epubjs/screenfull.min.js"></script>
    {/if}
{/block}
