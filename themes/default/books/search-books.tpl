    ...
    <script>
        $(document).on('change', '#countPerPage', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: url,
                data: $('#book-filter, #books-sort, #countPerPage, #searchText').serialize() + '&sortOrder=' + $('option:selected', '#books-sort').attr('data-order') + '&books_row=book-3-row&size_grid=col-sm-12+col-md-6+col-lg-4',
                beforeSend: function () {
                    $('#preloader-book').show();
                },
