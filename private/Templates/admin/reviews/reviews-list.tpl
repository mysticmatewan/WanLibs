        ...
        {if isset($reviews) and $reviews != null}
            {foreach from=$reviews item=review name=review}
                <tr>
                    ...
                    <td>
                        <a href="{$routes->getRouteString("reviewEdit",["reviewId"=>$review->getId()])}" class="btn btn-outline-info btn-sm mr-1" data-container="body" data-toggle="tooltip" title="{t}Edit{/t}"><i class="fa fa-pencil"></i></a>
                        <div class="dropdown d-inline" data-trigger="hover" data-toggle="tooltip" title="{t}Delete{/t}">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="text-center">
                                    <button class="btn btn-outline-secondary delete-review" data-url="{$routes->getRouteString("reviewDelete",["reviewId"=>$review->getId()])}">
