...
{block name=toolbar}
    <div class="btn-group">
        <a href="{$routes->getRouteString("bookCreate")}" class="btn btn-success btn-icon-fixed"><i class="fa fa-plus"></i> {t}Add Book{/t}
        </a>
        <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="sr-only">Toggle Dropdown</span>
        </button>
        <div class="dropdown-menu">
            <a href="{$routes->getRouteString("bookCreate")}" class="dropdown-item "><i class="fa fa-hand-paper-o mr-1" aria-hidden="true"></i> {t}Manually{/t}
            </a>
            <a class="dropdown-item mr-1" data-toggle="collapse" href="#add-book-block" aria-expanded="false" aria-controls="collapseExample">
                <i class="fa fa-magic" aria-hidden="true"></i> {t}Google Books{/t}
            </a>
        </div>
    </div>
{/block}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="bulk-edit">{t}Save Changes{/t}</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="btn btn-success" id="add-book" data-container="body" data-placement="left" data-toggle="tooltip" title="{t}Add Book With Google Books{/t}"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <tr>
