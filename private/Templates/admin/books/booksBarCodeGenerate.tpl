                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border-top-0" style="width: 65px;">
                                    <a href="#" class="btn btn-success" id="add-book" data-container="body" data-toggle="tooltip" title="{t}Add Book{/t}"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    {foreach from=$books item=book name=book}
                                        <tr data-id="{$smarty.foreach.book.index}">
                                            ...
                                            <td class="text-center">
                                                <a href='#' class='btn btn-default remove-book' title='{t}Delete Book{/t}'><i class='fa fa-remove'></i></a>
                                            </td>
                                        </tr>
                                    {/foreach}
                                {/if}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="btn btn-primary pull-right" id="generate">
                                <i class="icon-magic-wand"></i> {t}Generate{/t}
                            </button>
                            <button type="button" class="btn btn-primary pull-left" id="print">
                                <i class="icon-printer"></i> {t}Print{/t}
                            </button>
                        </div>
                    </div>
                </div>
