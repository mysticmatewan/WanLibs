...
{block name=toolbar}
    {if $action == "edit"}
        <div class="heading-elements">
            <a href="{$routes->getRouteString("pageViewPublic",["pageUrl"=>$page->getUrl()])}" class="btn btn-success btn-icon-fixed" target="_blank">
                <i class="fa fa-eye"></i> {t}View Page{/t}
            </a>
        </div>
    {/if}
{/block}
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-outline-secondary disabled btn-icon-fixed pull-right save-page">
                            <span class="fa fa-floppy-o"></span> {t}Save{/t}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="card" id="image-block">
                <div class="card-body main-image-upload">
                    ...
                    <div class="fileinput {if $action == "edit" and $page->getImageId() != null}fileinput-exists{else}fileinput-new{/if}" style="width: 100%;" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 100%; min-height: 150px;">
                            {if $action == "edit" and $page->getImage() != null}
                                <img src="{$page->getImage()->getWebPath('small')}" alt="">
                            {else}
                                <img src="{$siteViewOptions->getOptionValue("noBookImageFilePath")}" alt="">
                            {/if}
                        </div>
                        <div>
                            <a href="#" class="btn btn-sm btn-outline-secondary fileinput-exists delete-main-img" data-id="{if $action == "edit" and isset($page)}{$page->getImageId()}{/if}" data-dismiss="fileinput">{t}Remove{/t}</a>
                            <span class="btn btn-sm btn-outline-secondary btn-file file-input">
                                ...
                                <input type="file" name="file" value="{if $action == "edit"}{if $page->getImageId() != null}{$page->getImageId()}{/if}{/if}">
                            </span>
