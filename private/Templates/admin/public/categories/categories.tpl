    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card" id="categories">
                <table class="table table-hover table-striped table-hover table-responsive">
                                        ...
                                        <div class="dropdown" data-trigger="hover" data-toggle="tooltip" title="{t}Delete{/t}">
                                            ...
                                            <ul class="dropdown-menu {if $activeLanguage->isRTL()}dropdown-menu-left{else}dropdown-menu-right{/if}">
                                                ...
                                                <li class="text-center">
                                                    <button class="btn btn-outline-secondary delete-category" data-delete="{$routes->getRouteString("categoryDelete",['categoryId'=>{$category->getId()}])}">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6"></td>
                            <td class="text-center">
                                <button type="button" class="btn btn-outline-success category-add" data-trigger="hover" data-toggle="tooltip" data-title="{t}Add Category{/t}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-success mb-2 {if $activeLanguage->isRTL()}ml-2{else}mr-2{/if} pull-right save-category">
                            <i class="fa fa-fw fa-floppy-o"></i> {t}Save{/t}
                        </button>
                    </div>
                </div>
            </div>
