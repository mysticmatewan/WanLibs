                ...
                <table class="table table-striped table-hover table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th>{t}Name{/t}</th>
                            <th>{t}Subject{/t}</th>
                            <th width="500">{t}Message{/t}</th>
                            <th width="165" class="text-center">{t}Submission Date{/t}</th>
                            <th width="75" class="text-center">{t}Actions{/t}</th>
                        </tr>
                    </thead>
                    <tbody>
                                        ...
                                        <div class="dropdown" data-trigger="hover" data-toggle="tooltip" title="{t}Delete{/t}">
                                            ...
                                            <ul class="dropdown-menu {if $activeLanguage->isRTL()}dropdown-menu-left{else}dropdown-menu-right{/if}">
                                                ...
                                                <li class="text-center">
                                                    <button class="btn btn-outline-secondary delete-message" data-url="{$routes->getRouteString("userMessageDelete",["messageId"=>$message->getId()])}">
