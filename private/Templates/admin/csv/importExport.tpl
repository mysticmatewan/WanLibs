                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class='text-center'>
                                <a href="#" class="btn btn-outline-success btn-icon-fixed" id="import"><i class="fa fa-file-excel-o" aria-hidden="true"></i> {t}Import{/t}
                                </a>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="btn btn-outline-success btn-icon-fixed" id="export"><i class="fa fa-file-excel-o" aria-hidden="true"></i> {t}Export{/t}
                                </a>
                            </td>
                        </tr>
                    </tbody>
                ...
                config: {
                    ...
                    complete: function (results, file) {
                        ...
                        if (file.type == 'application/vnd.ms-excel') {
                            ...
                            app.notification('error', '{t}Accepted Only CSV File{/t}');
                        }
                    }
                },
