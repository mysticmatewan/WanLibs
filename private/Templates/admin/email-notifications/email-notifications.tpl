...
{*block name=toolbar}
    <div class="heading-elements">
        <a href="{$routes->getRouteString("emailNotificationCreate")}" class="btn btn-success btn-icon-fixed" target="_blank">
            <i class="fa fa-plus"></i> {t}Add Notification{/t}
        </a>
    </div>
{/block*}
{block name=content}
                    ...
                    <tbody>
                        {foreach from=$emailNotifications item=emailNotification name=emailNotification}
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{$routes->getRouteString("emailNotificationEdit",["route"=>$emailNotification->getRoute()])}" class="btn btn-outline-info btn-sm" data-container="body" data-toggle="tooltip" title="{t}Edit{/t}"><i class="fa fa-pencil"></i></a>
                                </td>
                            </tr>
                        {/foreach}
                    </tbody>
