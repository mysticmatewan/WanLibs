                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switch switch-sm">
                                            <input type="checkbox" name="isEnabled" value="1"{if $ldapSettings->isEnabled()} checked{/if}>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <label class="switch switch-sm">
                                            <input type="checkbox" name="isUserAutoRegistration" value="1"{if $ldapSettings->isUserAutoRegistration()} checked{/if}>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <label class="switch switch-sm">
                                            <input type="checkbox" name="isUseBothAuth" value="1"{if $ldapSettings->isUseBothAuth()} checked{/if}>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <button type="button" class="btn btn-primary testConnection">
                                        <i class="fa fa-rocket" aria-hidden="true"></i> {t}Test Connection{/t}
                                    </button>
                                </div>
                            </div>
                        </div>
