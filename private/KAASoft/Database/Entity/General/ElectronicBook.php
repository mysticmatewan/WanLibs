    ...
    class ElectronicBook extends DatabaseEntity implements JsonSerializable {
        ...
        public function getWebPath() {
            ...
            if (file_exists($electronicBookFullPath) and $this->getPath() !== null) {
                ...
                $noElectronicBookPath = $siteViewOptions->getOptionValue(SiteViewOptions::NO_BOOK_IMAGE_FILE_PATH);

                return file_exists(FileHelper::getSiteRoot() . $noElectronicBookPath) ? $noElectronicBookPath : null;*/
                return _("eBook file was removed on hard drive but not in database.");
            }
        }
