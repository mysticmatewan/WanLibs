    ...
    abstract class ActionBase extends ControllerBase {
        ...
        protected function getPerPage($sessionPerPageVarName, $defaultValue = 10) {
            ...
            if (isset( $_POST["perPage"] )) {
                $perPage = ValidationHelper::getNullableInt($_POST["perPage"]);
        ...
        protected function getSortingColumn($sessionSortingColumnVarName, $defaultValue = null) {
            ...
            if (isset( $_POST["sortColumn"] )) {
                $sortColumn = ValidationHelper::getString($_POST["sortColumn"]);
        ...
        protected function getSortingOrder($sessionSortingOrderVarName, $defaultValue = "ASC") {
            ...
            if (isset( $_POST["sortOrder"] )) {
                $sortOrder = ValidationHelper::getDatabaseSortOrder($_POST["sortOrder"]);
        ...
        protected function sendEmail() {
            ...
            if ($emailNotification !== null and $emailNotification->isEnabled()) {
                ...
                try {
                    ...
                    $emailContent = "<html><body>" . Helper::printExceptionAsString($e,
