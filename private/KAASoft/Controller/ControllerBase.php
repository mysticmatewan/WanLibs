    ...
    abstract class ControllerBase implements Controller {
        ...
        public function __construct(Route $activeRoute = null, $isInitDatabase = true) {
            try {
                ...
                ControllerBase::getLogger()->log(LoggerLevel::toLevel(LoggerLevel::FATAL),
                                                 "Critical error is occurred. See details below:",
                                                 $e);
        ...
        public static function getLogger() {
            if (self::$LOGGER === null) {
                ...
                $pattern = '%date{Y-m-d H:i:s.u} %-15server{REMOTE_ADDR} [%level][%class:%method] %message%newline%exception';
                ...
                self::$LOGGER->setLevel(LoggerLevel::toLevel(LoggerLevel::DEBUG));
        ...
        protected function initGlobalSmartyVariables() {
            ...
            if ($isPublicRoute) {
                $this->smarty->assign("themePath",
                                      $resourcePath . FileHelper::THEMES_FOLDER_NAME . HttpClient::HTTP_PATH_SEPARATOR . ControllerBase::getThemeSettings()->getActiveTheme() . HttpClient::HTTP_PATH_SEPARATOR);
            }
        ...
        protected function baseStartAction() {
            try {
                ...
                ControllerBase::getLogger()->log(LoggerLevel::toLevel(LoggerLevel::FATAL),
                                                 _("Critical error is occurred. See details below:"),
                                                 $e);
                Helper::processFatalException($e,
                                              $this->routeController);
            }
