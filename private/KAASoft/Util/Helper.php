    ...
    class Helper {
        ...
        public static function printException(Exception $e, $message = "") {
            ...
            Helper::printTableRow([ _("Trace:"),
                                    utf8_encode(Helper::getExceptionTraceAsString($e)) ]);
         ...
         * @return string
         */
        public static function printExceptionAsString(Exception $e, $message = "") {
         ...
         * @return string
         */
        private static function getExceptionTraceAsString(Exception $e) {
            $trace = "";
            $index = 0;
         ...
         */
        public static function processFatalException(Exception $e, RouteController $routeController, $isOnEpicFailPage = false) {
            $errorMessage = _("Oops!!! Critical error is occurred. See details below:");
            Session::addSessionMessage(Config::DEBUG_MODE ? Helper::printExceptionAsString($e,
